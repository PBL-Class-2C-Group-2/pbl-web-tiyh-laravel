                ...
                <div class="container-fluid">
                    <div class="card card-info card-outline">
                        <div class="card-header bg-success">
                            <h3 style="color:white;">Form Tambah Slide Banner</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('slide.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="judul_slide" name="judul_slide" class="form-control" placeholder="Masukan Judul">
                                </div>
                                <div class="form-group">
                                    <label for="link">Link Slide</label>
                                    <input type="text" name="link" id="link" class="form-control" placeholder="Masukan Link">
                                </div>
                                <div class="form-group">

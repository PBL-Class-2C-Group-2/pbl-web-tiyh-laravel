                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('toko.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_toko" name="nama_toko" class="form-control" placeholder="Masukan Nama Toko/Lapak">
                                </div>
                                <div class="form-group">
                                    <label for="">No Telp <span class="text-dark">(*contoh pengisian: 6281234567890)</span></label>
                                    <input type="text" id="no_telp" name="no_telp" class="form-control" placeholder="Masukan Nomor Telephone">
                                </div>
                                <div class="form-group">

                ...
                <div class="container-fluid">
                    <div class="card card-info card-outline">
                        <div class="card-header bg-success">
                            <h3 style="color:white;">Form Ubah Kategori Produk</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('kategori_produk.update', $kategori->id ) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="slug" name="slug" class="form-control" value="{{ $kategori->slug }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="gambar">Gambar Kategori</label>
                                    <input type="file" name="gambar" id="gambar" class="form-control">
                                    <br><label for="">Gambar Saat Ini : </label><br>
                                    <img src=" {{ asset('uploads/' . $kategori->gambar) }} " width="150">
                                </div>
                                <div class="form-group">
